...
CREATE TABLE `common_text` (
                               ...
                               PRIMARY KEY (`id`),
                               KEY `idx_fid` (`fid`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='大字段存储';
...
CREATE TABLE `component_text` (
                                  ...
                                  PRIMARY KEY (`id`),
                                  KEY `idx_fid` (`fid`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='大字段存储';
