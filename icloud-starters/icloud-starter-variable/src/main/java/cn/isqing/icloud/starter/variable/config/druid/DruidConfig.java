...
public class DruidConfig {
    ...
    public Slf4jLogFilter slf4jLogFilter(@Qualifier("iVariableDataSource") DruidDataSource dataSource) {
        try {
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier("iVariableDataSource") DataSource dataSource) throws Exception {
        ...
        //factoryBean.setMapperLocations(new PathMatchingResourcePatternResolver().getResource("classpath:mybatis/ivariable/**/*xml"));
