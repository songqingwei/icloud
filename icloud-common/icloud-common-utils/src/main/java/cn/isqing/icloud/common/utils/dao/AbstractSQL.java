...
/**
 * {@link org.apache.ibatis.jdbc.AbstractSQL}
 * 增加了一个方法 {@link AbstractSQL#REMOVE_SELECT(java.lang.String)}
 */
public abstract class AbstractSQL<T> {
    ...
    public T REMOVE_SELECT(String columns) {
        sql().select.remove(columns);
        return getSelf();
    }
