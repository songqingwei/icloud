...
-- 插入初始数据
-- 注意：密码字段为空，系统将使用配置的默认密码进行认证
INSERT INTO `admin_user` (`id`, `username`, `password`, `nickname`, `status`) VALUES (1, 'admin', '', '管理员', 1);
INSERT INTO `admin_role` (`id`, `name`, `code`) VALUES (1, '管理员', 'ROLE_ADMIN');
